...
const Reviews = () => {
  return (
    <section className='max-w-7xl mx-auto border-b-2' id='reviews'>
        <div className='my-20'>
            <h2 className='text-xl lg:text-2xl tracking-tight text-center uppercase mb-12'>Reviews</h2>
            <p className='max-w-2xl text-lg mb-12 text-center mx-auto'> {REVIEWS.text} </p>
            <div className='flex flex-wrap justify-center'> {REVIEWS.reviews.map((review, index) => (
